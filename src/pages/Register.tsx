...
import { ShoppingCart, Eye, EyeOff, Mail, Lock, User } from "lucide-react";
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="bg-background/95 backdrop-blur-sm shadow-elegant border-0">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Join Loot Cart and start your shopping journey
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-start space-x-2">
                ...
                <Label
                  htmlFor="terms"
                  className="text-sm font-normal cursor-pointer leading-4"
                >
                  I agree to the{" "}
